                ...
                <form action="ExamenController.php?action=store" method="post">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="numero_examen" placeholder="EX20220982">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="nom" placeholder="Examen de Mathématiques">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="saison">Saison</label>
                            <input type="text" class="form-control" name="saison" placeholder="Été 2024">
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-6">
