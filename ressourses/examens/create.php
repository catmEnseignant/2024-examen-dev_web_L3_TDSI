                    ...
                    <form action="ExamenController.php?action=store" method="post">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="nom" class="form-control" id="exampleInputEmail1" placeholder="Algebre">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Date</label>
                                <input type="date" name="date" class="form-control" id="exampleInputEmail1" placeholder="12/3/2023">
                            </div>
                            <div class="form-group col-md-6">
