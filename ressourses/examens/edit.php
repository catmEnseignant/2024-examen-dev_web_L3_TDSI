                    ...
                    <form action="ExamenController.php?action=update" method="post">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="numero_examen" id="exampleInputEmail1"  value="<?php echo $examen['numero_examen'] ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">nom</label>
                                <input type="text" name="nom" class="form-control" id="exampleInputEmail1" value="<?php echo $examen['nom'] ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Date</label>
                                <input type="text" name="date" class="form-control" id="exampleInputEmail1"  value="<?php echo $examen['date'] ?>">
                            </div>
                            <div class="form-group col-md-6">
