...
?>
    ...
    <div class="container bg-light divBreakClass1">
        <div class="container bg-light divBreakClass2">
            <div class="bg-white divBreakClass3">s
                    ...
                    <form action="ExamenController.php?action=update" method="post">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Numéro d'examens</label>
                                <input type="number" class="form-control" name="numero_examen" id="exampleInputEmail1" placeholder="n°examen" value="<?php echo $examen['numero_examen'] ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Date</label>
                                <input type="date" name="date" class="form-control" id="exampleInputEmail1" placeholder="Date" value="<?php echo $examen['date'] ?>">
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Nom </label>
                                <input type="text" class="form-control" name="nom" placeholder="Nom de l'examen" value="<?php echo $examen['nom'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="saison" class="form-control" id="exampleInputEmail1" placeholder="Saison" value="<?php echo $examen['saison'] ?>">
                            </div>
