                    ...
                    <form action="ExamenController.php?action=update" method="post">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">numero_examen</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="nom" class="form-control" id="exampleInputEmail1" placeholder="algebre" value="<?php echo $examen['nom'] ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">date</label>
                                <input type="date" name="date" class="form-control" id="exampleInputEmail1" placeholder="20/10/2024" value="<?php echo $examen['date'] ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">saision</label>
