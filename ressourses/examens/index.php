        ...
        <div class="bg-white divBreakClass3">
            ...
            <div>
                <div class="center row bg-light divAdmin">
                    ...
                    <div class="col-4">Nombre d'examens disponibles <strong><?php echo count($examens) > 0 ? count($examens) : '0'; ?> </strong></div>
                    <div class="col-4 text-end">
                        <a href="ExamenController.php?action=create" class="btn btn-outline-primary me-3"><span class="p-2">Ajouter un examen</span></a>
                    </div>
                </div>
            </div>
            <table class="table">
                ...
                <tbody>
                    <?php
                        if ($examens) {
                            ...
                            echo "<tr><td colspan='5' class='text-center'>Aucun examen trouvé.</td></tr>";
                        }
                    ?>
                </tbody>
            </table>
