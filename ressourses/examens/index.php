            ...
            <div class="bg-white divBreakClass3">
                <nav aria-label="breadcrumb" class="divBreakClass4">
                    <ol class="breadcrumb divBreakClass5">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Listes des examen</li>
                    </ol>
                </nav>
                <div>
                    <div class="center row bg-light divAdmin">
                        <div class="col-4">Listes des examen </div>
                        <div class="col-4">Nombre d'examen<strong><?php echo count($examens) ?> </strong> </div>
