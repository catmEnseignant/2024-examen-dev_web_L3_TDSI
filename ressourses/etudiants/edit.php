                    ...
                    <form action="EtudiantController.php?action=update" method="post">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="numero_carte" id="exampleInputEmail1" placeholder="20220982HZT" value="<?php echo $etudiant['numero_carte'] ?>" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Prénom</label>
                                <input type="text" name="prenom" class="form-control" id="exampleInputEmail1" placeholder="Moussa" value="<?php echo $etudiant['prenom'] ?>" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Nom</label>
                                <input type="text" name="nom" class="form-control" id="exampleInputEmail1" placeholder="Diop" value="<?php echo $etudiant['nom'] ?>" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Adresse</label>
                                <input type="text" class="form-control" name="adresse" placeholder="Grand-Yoff" value="<?php echo $etudiant['adresse'] ?>" required>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
