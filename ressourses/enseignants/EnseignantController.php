...
function store()
{
    ...
    $query = "INSERT INTO enseignants (matricule, prenom, nom, adresse) VALUES (:matricule, :prenom, :nom, :adresse)";
...
function update()
{
    ...
    $query = "UPDATE enseignants SET  prenom = :prenom, nom = :nom, adresse = :adresse WHERE matricule = :matricule";
