...
function store() {
    ...
    $query = "INSERT INTO enseignants (matricule, prenom, nom, adresse, email) 
              VALUES (:matricule, :prenom, :nom, :adresse, :email)";
...
function update() {
    $pdo = connectionDB();
    // Exemple de données à mettre à jour (valeurs variables)
    $matricule = $_POST['matricule'];
    $prenom = $_POST['prenom'];
    $nom = $_POST['nom'];
    $adresse = $_POST['adresse'];
    ...
    // Correction de la requête de mise à jour
