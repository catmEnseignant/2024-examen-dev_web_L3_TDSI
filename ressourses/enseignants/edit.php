...
// assignez-les à la variable $enseignants
                ...
                <form action="EnseignantController.php?action=update" method="post">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="matricule" id="exampleInputEmail1" placeholder="AA-229-AA" value="<?php echo $enseignant['matricule']; ?>" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1 mb-2">Prénom</label>
                            <input type="text" name="prenom" class="form-control" id="exampleInputEmail1" placeholder="Moussa" value="<?php echo $enseignant['prenom']; ?>" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1 mb-2">Nom</label>
                            <input type="text" name="nom" class="form-control" id="exampleInputEmail1" placeholder="Diop" value="<?php echo $enseignant['nom']; ?>" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1 mb-2">Adresse</label>
                            <input type="text" class="form-control" name="adresse" placeholder="Grand-Yoff" value="<?php echo $enseignant['adresse']; ?>" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1 mb-2">Email</label>
                            <input type="text" name="email" class="form-control" id="exampleInputEmail1" placeholder="Diop" value="<?php echo $enseignant['email']; ?>">
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-6">
