                ...
                <form action="EnseignantController.php?action=update" method="post">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="matricule" value="<?php echo $enseignant['matricule'] ?>">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" class="form-control" name="email" value="<?php echo $enseignant['email'] ?>">
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-6">
