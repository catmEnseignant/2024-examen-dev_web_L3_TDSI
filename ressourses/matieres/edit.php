                    ...
                    <form action="MatiereController.php?action=update" method="post">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="code" id="exampleInputEmail1"  value="<?php echo $matiere['code'] ?>" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Nom</label>
                                <input type="text" name="nom" class="form-control" id="exampleInputEmail1"  value="<?php echo $matiere['nom'] ?>" required>
                            </div>
                        </div>
