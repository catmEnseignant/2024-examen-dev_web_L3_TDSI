            ...
            <div class="bg-white divBreakClass3">
                <nav aria-label="breadcrumb" class="divBreakClass4">
                    <ol class="breadcrumb divBreakClass5">
                        ...
                        <li class="breadcrumb-item divBreakClass6"><a href="#">Matieres</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Formulaire matieres</li>
                    </ol>
                </nav>
                <div>
                    ...
                    <form action="MatiereController.php?action=store" method="post">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="code" id="exampleInputEmail1" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Nom</label>
                                <input type="texte" name="nom" class="form-control" id="exampleInputEmail1" required>
                            </div>
                        </div>
