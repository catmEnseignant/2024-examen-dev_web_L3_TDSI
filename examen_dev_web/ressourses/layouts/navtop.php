<header class="pb-2 headerClass">
    ...
    <a class="navbar-brand" href="#">
        <img class="imgClass1 logo-circle" src="../../public/images/Soloquizz.png" alt="OLOQUIZZ">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <button class="px-3 btn btn-dark dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fas fa-user-circle" style="font-size: 24px; color: white;"></i> <!-- Icône de personne encercle -->
                            </button>
                            <ul class="dropdown-menu dropdown-menu-info">
                                ...
                                <li>
                                    <a class="dropdown-item text-dark" href="#">
                                        <span><i class="fas fa-power-off"></i></span>&nbsp;Deconnexion
                                    </a>
                                </li>
                            </ul>
                        </li>
