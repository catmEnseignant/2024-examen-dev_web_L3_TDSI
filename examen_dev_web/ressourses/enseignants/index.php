        ...
        <div class="bg-white divBreakClass3">
            ...
            <div>
                <div class="center row bg-light divAdmin">
                    <div class="col-4">Liste des enseignants</div>
                    <div class="col-4">Nombre d'enseignants <strong><?php echo count($enseignants); ?> </strong></div>
                    <div class="col-4 text-end">
                        <a href="EnseignantController.php?action=create" class="btn btn-outline-primary me-3">
                            <span class="p-2">Ajouter un enseignant</span>
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        foreach ($enseignants as $enseignant) {
                            echo
                                "<tr>
                                    ...
                                    <td>
                                        <a href='edit.php?matricule=".$enseignant['matricule']."' class='btn btn-success btn-sm'>
                                            <i class='glyphicon glyphicon-edit'></i> Modifier
                                        </a>
                                        <a href='EnseignantController.php?action=delete&matricule=".$enseignant['matricule']."' class='btn btn-danger btn-sm'>
