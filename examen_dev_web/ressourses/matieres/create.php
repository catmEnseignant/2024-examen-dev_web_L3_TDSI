    ...
    <div class="container bg-light divBreakClass2">
        <div class="bg-white divBreakClass3">
            ...
            <div class="center row container">
                <form action="MatiereController.php?action=store" method="post"> <!-- Vérifier le contrôleur -->
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="codeInput" class="mb-2">Code</label>
                            <input type="text" class="form-control" name="code" id="codeInput" placeholder="20220982HZT">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="nomInput" class="mb-2">Nom</label>
                            <input type="text" name="nom" class="form-control" id="nomInput" placeholder="dev_web">
                        </div>
                    </div>
