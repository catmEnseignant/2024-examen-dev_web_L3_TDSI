...
<?php
    ...
    $con = connectionDB();
    $mysqlTable = "matieres"; // Changement de table
        ...
        <div class="bg-white divBreakClass3">
            ...
            <div>
                <div class="center row bg-light divAdmin">
                    ...
                    <div class="col-4 text-end"><a href="MatiereController.php?action=create" class="btn btn-outline-primary me-3"><span class="p-2">Ajouter une matière</span></a></div>
                </div>
            </div>
            <table class="table">
                <thead>
                            ...
                            echo
                                "<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='MatiereController.php?action=delete&code=".$matiere['code']."' class='btn btn-danger btn-sm'><i class='glyphicon glyphicon-trash'></i> Supprimer</a>
                                    </td>
                                </tr>";
                        }
                    ?>
